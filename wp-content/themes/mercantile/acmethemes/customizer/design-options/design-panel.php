...
*/
require mercantile_file_directory('acmethemes/customizer/design-options/front-page-sidebar-layout.php');

/*
* file for front archive sidebar layout options
*/
require mercantile_file_directory('acmethemes/customizer/design-options/archive-sidebar-layout.php');
