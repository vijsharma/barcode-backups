...
class MercantilePro_Notice_Handler {
	...
	public function demo_lists( $demo_lists ) {
        $url = 'https://demo.acmethemes.com/wp-json/acmethemes-demo-api/v1/fetch_templates/?theme-slug=mercantile';
        $body_args = [
            /*API version*/
	...
	public function getting_started() {
        ...
        <div id="at-gsm" class="updated notice-info at-gsm">
            ...
            <div class="at-gsm-container">
                <img class="at-gsm-screenshot" src="<?php echo esc_url(get_template_directory_uri().'/screenshot.jpg' )?>" alt="<?php esc_html_e( 'Mercantile', 'mercantile' ); ?>" />
                <div class="at-gsm-notice">
                    ...
                    <a class="at-gsm-btn button button-primary button-hero" href="#" data-name="" data-slug="" aria-label="<?php esc_html_e( 'Get started with Mercantile', 'mercantile' ); ?>">
