 ...
 * Defining constants
 */
if( ! defined( 'GSL_VERSION' ) ) define( 'GSL_VERSION', '1.8.3' );
...
if ( ! function_exists('gs_logo_pro_link') ) {
    function gs_logo_pro_link( $gsLogo_links ) {
        $gsLogo_links[] = '<a style="color: red; font-weight: bold;" class="gs-pro-link" href="https://gsplugins.com/product/gs-logo-slider" target="_blank">Go Pro!</a>';
        $gsLogo_links[] = '<a href="https://gsplugins.com/wordpress-plugins" target="_blank">GS Plugins</a>';
        return $gsLogo_links;
    }
